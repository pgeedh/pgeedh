![logo](https://github.com/user-attachments/assets/1edca0fb-ab56-4dfd-bd17-68d5241acc64)
...
<div align="center">
  ...
  ### 🌱 Currently Learning
  - Advanced **Motion Planning (RRT*, MPC)**
  - **Neural SLAM** for dynamic environments
  - **3D LiDAR** processing techniques

  ### 💬 Let's Talk About
  - Robotics frameworks • Sensor fusion • Startup collaborations
</div>
...
|---------|-------------|------------|-------|
| **Sentry Max** | SLAM framework for AMRs (25% precision boost) | ROS2 • LiDAR • 3D Cameras | [![GitHub](https://img.shields.io/badge/Code-181717?logo=github)](https://github.com/pgeedh/Sentry-Max) |
| **Krabby Robot** | Underwater pipeline inspection robot | OpenCV • Ultrasonic Sensors | [![GitHub](https://img.shields.io/badge/Code-181717?logo=github)](https://github.com/pgeedh/Krabby) |
